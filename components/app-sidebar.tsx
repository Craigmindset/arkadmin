...
import { Home, Calendar, Music, Radio, Heart, BookOpen, Globe, LogOut, Users, Video, MessageSquare } from "lucide-react"
    ...
    <Sidebar className="border-r border-border">
      ...
      <SidebarContent className="bg-sidebar">
        <SidebarGroup className="py-2">
          <SidebarGroupLabel className="mb-2 text-sidebar-foreground/70">Navigation</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {menuItems.map((item) => (
